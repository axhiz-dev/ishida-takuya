...
import { engineerBio, engineerCareer, engineerStats } from "@/content/engineer";
import { totalExperienceYears } from "@/lib/derive";

/**
 * 経験年数だけは career の期間から導出する。
 * ゲート（/）の扉に出る「◯ 年」と必ず同じ数字になる。
 */
export function About() {
  const stats = [
    { value: totalExperienceYears(engineerCareer), suffix: "年", label: "Web 開発の経験" },
    ...engineerStats,
  ];
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-12 md:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] md:gap-16">
          ...
          <Reveal direction="left" className="mx-auto w-full max-w-xs md:sticky md:top-28">
            <div className="relative aspect-square" data-print="hide">
              {/* 回転コニックリング */}
              <div
                aria-hidden="true"
