...
import { engineerProjects } from "@/content/engineer";
import { isExternal } from "../ui/SocialIcon";
              ...
              <Tilt3D className="h-full">
                <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/8 bg-surface/70 p-7">
                  ...
                  <div className="relative flex items-start justify-between gap-4">
                    <div>
                      <p className="font-mono text-xs text-brand-cyan">{project.category}</p>
                  ...
                  {project.links && project.links.length > 0 && (
                    <div
                      data-print="hide"
                      className="relative mt-5 flex flex-wrap gap-4 border-t border-white/5 pt-4"
                    >
