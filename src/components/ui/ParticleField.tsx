...
/**
 * ヒーロー背景の自作パーティクル・コンステレーション。
 * - rAF ループで漂う粒 + 近接線を描画、ポインタにゆるく引き寄せる
 * - DPR 対応（上限2）、面積に応じて粒数を調整
 * - document.hidden で停止（電力・CPU 節約）
 * - reduced-motion / 小型タッチ端末では描画せず静的グラデにフォールバック
 */
